...
ADMINS = (
    ('Sanchit Bareja', 'sanchitbareja@gmail.com'), ('Vishnu Jayaprakash', 'soorse@gmail.com')
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'edubase',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '&amp;gq83x^q-kdc^=rpdib@nfymb627g_$*7w8f30s38!2xzqn5p0'
